    ...
    return (
        ...
        <main>
                        ...
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-zinc-950 md:dark:bg-zinc-950">
                            ...
                            <li>
                                <a
                                    ...
                                    rel="noopener noreferrer"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="20" viewBox="0 0 30 30" className="mr-1" fill="currentColor">
            ...
            <div className="flex flex-col items-center mt-32 pb-16">
                ...
                <p className="mb-0 pt-6 text-[21px] font-normal tracking-wide text-gray-600 dark:text-gray-400" data-aos="fade-down">
                ...
                <InteractiveHoverButton text="Start" className="mt-8 text-[17.5px]" data-aos="fade-in"/>
